...
function Projects() {
  return (
    ...
    <section
      className="flex flex-col items-center w-[calc(100svw-6rem)] h-svh pt-24"
      id="projects"
    >
      ...
      >
        {Array.from({ length: 4 }, (_, index) => (
          ...
          >
            <h1 className="font-ottercob text-2xl bg-gradient-to-r from-stone-900 to-stone-400 text-transparent bg-clip-text">
              Project {index + 1}
            </h1>
