      ...
      <section className="flex flex-col items-center">
        ...
        <div className="flex flex-col items-center bg-gradient-to-r from-stone-900 to-stone-400 text-transparent bg-clip-text rounded-3xl border border-stone-200 w-auto p-5 my-10 mx-4">
          <p className="font-ottercol text-md">
            ...
            MongoDB, and more. I'm always looking to learn new things and
            improve my skills. I'm currently looking for new opportunities to
            work on exciting projects with a great team. If you're interested in
            working with me, feel free to reach out!
          </p>
        </div>
      </section>
    </div>
